...
style = 'img {max-width: 30rem} span {display: block; text-align: center;}'
output.get_output().add_style(style)
output.get_output().set_width(500)
output.get_output().set_height(440)
out = script.get_output()
out.print_image(svg)
out.print_html('<div style="padding: 0 1rem"><h2>Revitron</h2>A Revit API wrapper written in Python.<br>' +\
